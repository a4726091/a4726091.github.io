...
var rightClickInPutButton = new creatNewrightClickButton(100, 10, 80, 20, "#000000", "Lightyellow", inputSaveData, "匯入存檔");
var rightClickOutPutButton = new creatNewrightClickButton(100, 70, 80, 20, "#000000", "Lightyellow", outputSaveData, "匯出存檔");
var inputImgBitton = new creatNewrightClickButton(100, 40, 80, 20, "#000000", "Lightyellow", doNotThing, "匯入圖片");
var rightClickfindBubble = new creatNewrightClickButton(100, 130, 80, 20, "#000000", "Lightyellow", findbubble2, "尋找泡泡球");
var outputImg = new creatNewrightClickButton(100, 100, 80, 20, "#000000", "Lightyellow", outputContainToImage, "匯出成圖片");
var rightClickOkButton = new creatNewrightClickButton(190, 160, 80, 20, "#000000", "#ff1571", rightClickOk, "確定");
var rightClickfindBubble = new creatNewrightClickButton(100, 160, 80, 20, "#000000", "Lightyellow", changeNumber, "數字變更");
...
function findbubble2() {
		...
		for (var i = 0; i < inputbubblenumber.length; i++) {
				if (inputbubblenumber[i] == textTemp.value) {
